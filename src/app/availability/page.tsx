...
export default function AvailabilityPage() {
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col">
      ...
      {/* AppFolio Listings Embed — fallback button shows if iframe is blocked */}
      <div className="flex-1 relative" style={{ minHeight: "calc(100vh - 72px)" }}>
        <iframe
          ...
          allow="fullscreen"
        />
        {/* Fallback — visible behind iframe if AppFolio blocks embedding */}
        <div className="absolute inset-0 flex items-center justify-center bg-stone-100 -z-10">
          <div className="text-center px-6 max-w-lg">
            ...
            <p className="text-stone-600 mb-6">
              Browse our current manufactured home lots and RV sites on the listings portal.
            </p>
            <a
